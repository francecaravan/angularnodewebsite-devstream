...
;(function( window, $ ) {
	...
	SliderProSlide.prototype = {
		...
		resizeMainImage: function( isNewImage ) {
			...
			//KT - adjusted line 1132 to have height 100%
			//KT - adjusted line 1135 to have width 100%
			//KT - adjusted line 1140 to have height 100%
			//KT - adjusted line 1143 to have width 100%
			//KT - adjusted line 1151 to have margins of zero
			if ( this.settings.autoHeight === true ) {
				...
				if ( this.settings.centerImage === true ) {
					this.$mainImage.css({'marginLeft':'0px','marginTop':'0px'});
...
;(function( window, $ ) {
	...
	Thumbnail.prototype = {
		...
		resizeImage: function() {
			...
			// KT changed line 2050 to make height 100%
			// KT changed line 2053 to make width 100%
